<template>
  <ul class="header-nav-first">
      ...
      <li class="has-child">
        ...
        <ul class="header-nav-second header-nav-merchant">
          <li><router-link to="/">美团餐饮商户中心</router-link></li>
          <li><router-link to="/">登录商家中心</router-link></li>
          <li><router-link to="/">美团智能收银</router-link></li>
          <li><router-link to="/">我想合作</router-link></li>
          <li><router-link to="/">手机免费开店</router-link></li>
          <li><router-link to="/">到店综合业务招募</router-link></li>
          <li><router-link to="/">餐饮合作商招募</router-link></li>
          <li><router-link to="/">商家申请开票</router-link></li>
      ...
      <li class="has-child">
        ...
        <div class="header-nav-second header-nav-site">
          <dl class="header-nav-third header-jiulv">
            <dt>酒店旅游</dt>
            <dd>
          ...
          <dl class="header-nav-third header-meishi">
            <dt>吃美食</dt>
            <dd>
          ...
          <dl class="header-nav-third header-movie">
            <dt>看电影</dt>
            <dd>
          ...
          <dl class="header-nav-third header-app">
            <dt>手机应用</dt>
            <dd>
                <router-link to="/">
